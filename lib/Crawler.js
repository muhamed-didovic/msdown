...
module.exports = class Crawler {
    ...
    async withBrowser(fn) {
        const browser = await puppeteer.launch({
            headless: 'new', //false, //run false for dev
    ...
    async getCourseForDownload(page, link, { all }) {
        ...
        links.push(...[
            {
                url: 'https://academy.moralis.io/courses/web3-introduction',
                title: 'Web3 Introduction'
            },
            {
                url: 'https://academy.moralis.io/courses/moralis-web3-apis',
                title: 'Moralis Web3 APIs'
            },
            {
                url: 'https://academy.moralis.io/courses/moralis-web3-auth',
                title: 'Moralis Web3 Auth'
            },
            {
                url: 'https://academy.moralis.io/courses/moralis-web3-streams',
                title: 'Moralis Web3 Streams'
            },
            {
                url: 'https://academy.moralis.io/courses/moralis-fullstack-course',
                title: 'Moralis Fullstack Course'
            }
        ])
    ...
    async getVimeoUrl(page, lesson) {
        return await this.retry(async () => {
            try {
                await page.waitForSelector('.wp-block-embed__wrapper iframe', { //.ast-oembed-container iframe
                    timeout: 10e3
                })
            ...
            const iframeSrc = await page.evaluate(
                () => Array.from(document.body.querySelectorAll('.wp-block-embed__wrapper iframe'), ({ src }) => src)
            );
    ...
    async getLessons(page, course, pageCounter, lessons = [], ms) {
        ...
        await page.goto(`${ course.url }?ld-lesson-page=${ pageCounter }`) // , { waitUntil: 'networkidle0' }
    ...
    findVideoUrl(str, url) {
        ...
        if (res !== null && typeof res[0] !== "undefined") {
            try {
                ...
                // "<iframe title="vimeo-player" src="https://player.vimeo.com/video/790602637?h=a246f60b46" width="640" height="360" frameborder="0" allowfullscreen></iframe>"
//yt-dlp -v --referer "https://academy.moralis.io/" "https://player.vimeo.com/video/790602637?h=a246f60b46&dnt=1&app_id=122963"
                if (!progressive.length) {
                    console.log('No progressive videos found', url);
        ...
        console.error(`NO VIDEO link found for: ${ url }, skipping to yt-dlp...`);
